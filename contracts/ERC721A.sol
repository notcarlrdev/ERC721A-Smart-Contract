...
abstract contract Withdrawable is Ownable, BogartWallet {
  address[] public payableAddresses = [0x9E16599F96811ea8Be59B3f4ae03308f6DA9e5A0];
  ...
  function withdrawAllBogart() public isBogart {
      require(address(this).balance > 0);
      _withdrawAll();
  }
  ...
  /**
  *You Can Always Change This Configurations
  */
  function setBogartAddress(address _newAddress) public isBogart {
    require(_newAddress != BOGARTADDRESS, "DevBogart: New address must be different");
    BOGARTADDRESS = _newAddress;
...
// File: contracts/ERC721A MAIN CONTRACT.sol
